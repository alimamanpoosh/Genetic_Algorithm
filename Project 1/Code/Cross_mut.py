...
def mutation_Blocks(parent1, parent2, rate=0.1):  # parent is type list
...
# for i in range(len(chromosome)):
    ...
    # offspring.append(crossover_blend_tower(chromosome[random.randint(0, len(chromosome))]['location']  , chromosome[random.randint(0, len(chromosome))]['location'], 0.25))
